...
def record_clearance_event(
    ...
    try:
        put("ledgix.request_id", clearance.request_id)
        put("ledgix.decision_status", clearance.decision_status)
        put("ledgix.status", clearance.status)
        put("ledgix.reason_code", clearance.reason_code)
        put("ledgix.reason", clearance.reason)
        put("ledgix.policy_version_id", clearance.policy_version_id)
        put("ledgix.policy_content_hash", clearance.policy_content_hash)
        put("ledgix.confidence_bucket", clearance.confidence_bucket)
        put("ledgix.minimum_confidence_bucket", clearance.minimum_confidence_bucket)
        put("ledgix.tool_name", request.tool_name)
        put("ledgix.agent_id", request.agent_id)
        put("ledgix.session_id", request.session_id)
        put("ledgix.requires_manual_review", clearance.requires_manual_review)
        put("ledgix.latency_ms", getattr(clearance, "latency_ms", None))
